...
{
    public class UserApiService : SingModel<UserApiService>
    {
        ...
        /// <returns></returns>
        public ResponseResult SaveUserWeChat(UserWeChatRequest request)
        {
            return Post<UserWeChatRequest, ResponseResult>(request, "/api/User/SaveUserWeChat");
        }

        public ResponseResult DeleteUserWeChat(UserWeChatRequest request)
        {
            return Post<UserWeChatRequest, ResponseResult>(request, "/api/User/DeleteUserWeChat");
        }
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        public ResponseResult GetUserWeChat(UserWeChatRequest request)
        {
            return Get<UserWeChatRequest, ResponseResult>(request, "/api/User/GetUserWeChat");
        }
